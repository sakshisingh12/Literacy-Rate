...
def data(people):
    if people == "Youth (15-24)":
        youth_data = pd.read_csv("https://github.com/sakshisingh12/Literacy-Rate/blob/main/app/youth_data.csv", usecols=range(0, 9), delimiter=",", encoding='utf-8')
        st.write("""
            ## Youth 
        ...
        adult_data = pd.read_csv("https://github.com/sakshisingh12/Literacy-Rate/blob/main/app/adults_data.csv", usecols=range(0, 9),delimiter=",", encoding='utf-8')
        st.write("""
            ## Adults
